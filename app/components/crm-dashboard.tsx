...
import { CalendarIcon, MagnifyingGlassIcon, GearIcon, PlusIcon, EnvelopeClosedIcon, ChevronRightIcon } from "@radix-ui/react-icons"
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  <MagnifyingGlassIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white/40 h-4 w-4" />
                  <Input
